// ADDED ASSISTS
function Player(name, attr, tendency) {
  this.name = name;
  this.shooting = attr;  //can add 2pt and 3pt and layUp
  this.dribbling = attr;
  this.passing = attr;
  this.passTendency = tendency;
  this.points = 0; 
  this.rebounds = 0;  // could make these part of a copy object for encapsulation? 
...
{
 console.log("Name: " + obj.name + " PTS: " + obj.points + " RBS: " + obj.rebounds + " AST: " + obj.assists
...
function printTeamStats()
{
  ...
  teamAssists = player1.assists + player2.assists + player3.assists + player4.assists + player5.assists;
  ...
  console.log("Team1  PTS:" + teamPoints + " RBS: " + teamRebounds + " AST: " + teamAssists + " ORB: " + teamOffensiveRebounds + 
  ...
  teamAssists2 = player6.assists + player7.assists + player8.assists + player9.assists + player10.assists;
  ...
  console.log("Team2  PTS:" + teamPoints2 + " RBS: " + teamRebounds2 + " AST: " + teamAssists2 +
    " ORB: " + teamOffensiveRebounds2 + " DRB: " + teamDefensiveRebounds2 + " FGA: " + teamFieldGoalsAttempted2 
